...
This file contains repository-specific working guidance for coding agents collaborating on **golf-prediction-betting-system**.

## Project Snapshot
- Repository: `golf-prediction-betting-system`
- Path: `/home/igorkan/repos/golf-prediction-betting-system`
- Purpose: Repository for Golf outcome prediction and betting workflows using publicly available data.
