...
Repository-specific working guide for coding agents on **Golf Prediction and Betting System**.

## Snapshot
- Repository: `golf-prediction-betting-system`
- Path: `/home/igorkan/repos/golf-prediction-betting-system`
- Purpose: Production-oriented repository for Golf outcome prediction and betting execution using publicly available data.
