...
## Goal
Create and maintain a reliable execution roadmap for **Golf Prediction and Betting System**.

## Context
Production-oriented repository for Golf outcome prediction and betting execution using publicly available data.
